<div class="subheadline wrap-m">
	...
	<div class="sh-main wrap-c">
		<div class="sh-title text-info fs-18 fw-5"><i class="far fa-edit"></i> <?php _e('Edit User')?></div>
	</div>
			...
			<div class="col-md-6">
				<form>
                    ...
                    <div class="form-group wrap-m">
						<div class="wrap-c">
							<label class="i-checkbox i-checkbox--tick i-checkbox--brand m-r-10" style="margin-left:10px;margin-top:10px">
								<input type="checkbox" name="fe" value="1" checked><?php _e('FE (Basic)')?><span></span>
							</label>
						<br>
                        <label class="i-checkbox i-checkbox--tick i-checkbox--brand m-r-10" style="margin-left:10px;margin-top:10px;">
								<input type="checkbox" name="unlimited" value="1" 
                                <?php _e(get_data($result, 'oto_1', 'checkbox', 1))?>> <?php _e('Unlimited')?><span></span>
							</label>
						</div>
