                ...
                <div class="col-md-6">    
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category" id="category" required="true">
                            ...
                            <option <?php _e( get_data($result, 'category', 'select', 'Health') )?>>Health</option>
                            ...
                            <option <?php _e( get_data($result, 'category', 'select', 'Automobile') )?>>Automobile</option>
                            <option <?php _e( get_data($result, 'category', 'select', 'Pet Care') )?>>Pet Care</option>
                            ...
                            <option <?php _e( get_data($result, 'category', 'select', 'Food') )?>>Food</option>
                             <option <?php _e( get_data($result, 'category', 'select', 'Others') )?>>Others</option>
                        </select>
                    </div> 
                 </div> 
               </div> 
