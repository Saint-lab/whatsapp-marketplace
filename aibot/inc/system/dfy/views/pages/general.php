    ...
    <div class="col-md-12">
        <div >
            <div class="card-header">
                <div class="card-title"><i class="fa fa-bookmark text-warning"></i> <?php _e("Done For You")?></div>
            </div>
            <br>
            <?php if($resultd !=null){  ?>
                    ...
                    <div class="btn-group">
						  	...
						  	<div class="dropdown-menu dropdown-menu-anim">
							    <a 
							    	...
							    	href="<?php _e( get_module_url('dfy/copy_market/'.$result['id']) )?>"
			    					data-history="<?php _e( get_module_url('dfy/copy_market/'.get_data($result, 'id') ) )?>" 
			    					data-call-after="Core.date();"
							    ><i class="fa fa-clone"></i> <?php _e('Copy')?></a>
