<div class="widget-box-add-account">
	...
	<ul class="list-group m-t-25">
		<li class="list-group-item active bg-info text-uppercase"><i class="far fa-question-circle"></i> <?php _e("To start using tool you need to connect your phone number.")?></li>
		<li class="list-group-item text-success">
			<div class="fw-6 m-b-5"><?php _e("Please make sure you joined Whatsapp Multi-Device Beta") ?></div>
			<div class="p-l-0"><?php _e("1. Go to WhatsApp Settings.")?></div>
			<div class="p-l-0"><?php _e("2. Tap Linked Devices.")?></div>
			<div class="p-l-0"><?php _e("3. Tap Multi-Device Beta.")?></div>
			<div class="p-l-0"><?php _e("4. Tap Join Beta.")?></div>
		</li>
