<div class="h-100 d-lg-flex">
    ...
    <div class="wa-menu flex-lg-column me-lg-1 ms-lg-0 d-flex justify-content-center overflow-hidden">
            ...
            <div class="d-lg-flex h-100">
                <div class="wa-menu-nav wa-accounts nav nav-pills justify-content-center my-auto overflow-hidden wa-scroll" id="wa-accounts">
                    <?php if( !empty($accounts) ){?>
                        ...
                        <div class="nav-item">
                            <a class="nav-link" href="javascript:void(0);" data-instance-id="<?php _e( $value->token )?>" data-access-token="<?php _e($access_token)?>" data-placement="auto" title="<?php _e($value->name)?>">
        ...
        <?php if(is_dir(FCPATH."api")){ ?>
        <div class="flex-lg-column wa-settings">
            <ul class="nav wa-menu-nav justify-content-center">
                <li class="nav-item w-100">
                    <a class="nav-link wa-reset-scrolll wa-action-item" href="<?php _e( get_module_url("get/api") )?>" data-result-submenu="wa-submenu-data" data-result-content="wa-content" title="<?php _e("API")?>">
