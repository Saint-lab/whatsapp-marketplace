<div class="container p-25">
        ...
        <div class="row">
            <div class="col-md-12 m-b-15">
                ...
                <a href="<?php _e( get_module_url("get/template_button_update/") )?>" class="wa-action-item btn btn-sm btn-info float-right" data-result-content="wa-content"><i class="ri-contacts-book-line"></i> <?php _e("Add new")?></a>
            </div>
                ...
                <div class="card mb-4 box-shadow">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <div class="text-muted text-center fs-12"><?php _e(  sprintf( __('%d buttons'), count(  json_decode($value->data)->templateButtons ) ) )?></div>
                        </p>
                        <div class="d-flex justify-content-center align-items-center text-center">
                            <div class="btn-group">
                                <a href="<?php _e( get_module_url("get/template_button_update/".$value->ids) )?>" class="wa-action-item btn btn-sm btn-label-info" data-result-content="wa-content"><i class="ri-edit-line" title="<?php _e("Edit")?>"></i></a>
        ...
        <div class="wrap-m h-100">
            <div class="empty">
                <div class="icon"></div>
                <a href="javascript:void(0);" class="btn btn-sm btn-info d-inline-block d-lg-none mr-2 wa-back-submenu" data-result="html"><i class="ri-arrow-left-s-line"></i> <?php _e("Back")?></a>
                <a href="<?php _e( get_module_url("get/template_button_update/") )?>" class="btn btn-sm btn-info wa-action-item" data-result-content="wa-content"><i class="ri-contacts-book-line"></i> <?php _e("Add new")?></a>
            </div>
        </div>
        <?php }?>
    </div>
