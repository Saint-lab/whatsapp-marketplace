...
<div class="tab-pane h-100 show active" id="pills-chat" role="tabpanel" aria-labelledby="pills-chat-tab">
    ...
    <div class="chat-message-detail wa-scroll px-2">
        <ul class="list-unstyled chat-list chat-user-list">
            ...
            <li class="unread wa-submenu-item wa-contact-group-shedule">
                <a class="wa-action-item wa-open-content" data-result-content="wa-content" href="<?php _e( get_module_url("get/contact_schedules") )?>">
                    <div class="d-flex">
                        ...
                        <div class="flex-1 overflow-hidden">
                            <h5 class="text-truncate fs-15 mb-1"><?php _e("Schedules")?></h5>
            ...
            <li class="unread wa-submenu-item">
                <a class="wa-action-item wa-open-content" data-result-content="wa-content" href="<?php _e( get_module_url("get/campaign_report") )?>">
                    <div class="d-flex">
                        <div class="chat-user-img away align-self-center mr-3 ms-0">
                            <div class="icon bg-info"><i class="fas fa-chart-pie"></i></div>
                        </div>
                        <div class="flex-1 overflow-hidden">
                            <h5 class="text-truncate fs-15 mb-1"><?php _e("Campaign reports")?></h5>
                            <p class="chat-user-message text-truncate fs-11 mb-0"><?php _e("Report all your campaigns")?></p>
                        </div>
                    </div>
                </a>
            </li>
