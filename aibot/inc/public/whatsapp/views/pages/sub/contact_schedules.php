	    ...
	    <div class="col-lg-6 col-md-6 m-b-30 item">
	        ...
	        <div class="card border-<?php _e($color)?>">
	            ...
	            <div class="card-body wa-scroll h-150 no-update">
	                <div class="card-toolbar">
	                    <div class="dropdown">
	                        ...
	                        <ul class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-anim dropdown-menu-top-unround">
	                            <li><a class="wa-action-item wa-open-content" data-result-content="wa-content" href="<?php _e( get_module_url('get/contact_create_campaign/'.$row->ids) )?>"><i class="far fa-edit"></i> <?php _e('Edit')?></a></li>
	                            <li><a class="" data-result-content="wa-content" href="<?php _e( get_module_url('bulk_report/'.$row->ids) )?>"><i class="fas fa-chart-pie"></i> <?php _e('Report')?></a></li>
	                ...
	                switch ($row->cate) {
	                	case 2:
	                		_e( "<span class='text-success'>".__('[BUTTON TEMPLATE]')."</span>", false);
	                		break;
	                	case 3:
	                		_e( "<span class='text-success'>".__('[LIST MESSAGE TEMPLATE]')."</span>", false);
	                		break;
