				...
				<div class="card mb-4 box-shadow">
					<div class="card-body">
						...
						<div class="d-flex justify-content-center align-items-center text-center">
							<div class="btn-group">
								<a href="<?php _e( get_module_url("get/contact_group_list/".$value->ids) )?>" class="action-contact-group-import btn btn-sm btn-label-info" data-result="html"><i class="ri-contacts-book-line" title="<?php _e("Contact")?>"></i></a>
								<a href="<?php _e( get_module_url("get/contact_group_import/".$value->ids) )?>" class="action-contact-group-import btn btn-sm btn-label-info" data-result="html"><i class="ri-user-add-line" title="<?php _e("Import contact")?>"></i></a>
								<a href="<?php _e( get_module_url("get/contact_group_update/".$value->ids) )?>" class="action-contact-group-import btn btn-sm btn-label-info" data-result="html"><i class="ri-edit-line" title="<?php _e("Edit contact group")?>"></i></a>
								<a href="<?php _e( get_module_url("delete_contact_group") )?>" data-id="<?php _e( $value->ids )?>" class="actionItem btn btn-sm btn-label-info" data-remove="item-contact-group" data-confirm="<?php _e("Are you sure to delete this items?")?>"><i class="ri-delete-bin-6-line"></i></a>
							</div>
