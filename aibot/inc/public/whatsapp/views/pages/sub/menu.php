<ul class="nav wa-menu-nav justify-content-center nav-tabs m-auto" id="nav-tab" role="tablist">
    ...
    <li class="nav-item" title="<?php _e("Profile")?>" aria-selected="false" data-toggle="" data-placement="right">
    ...
    <li class="nav-item" title="<?php _e("Chats")?>" aria-selected="false" data-toggle="" data-placement="right">
    ...
    <li class="nav-item d-none" title="<?php _e("Contacts")?>" aria-selected="false" data-toggle="" data-placement="right">
    ...
    <?php }?>
    <?php if( _p("whatsapp_autoresponder") ){?>
    <li class="nav-item" title="<?php _e("Autoresponder")?>" aria-selected="false" data-toggle="" data-placement="right">
    ...
    <li class="nav-item" title="<?php _e("Bulk messaging")?>" aria-selected="false" data-toggle="" data-placement="right">
    ...
    <li class="nav-item" title="<?php _e("Chatbot")?>" aria-selected="false" data-toggle="" data-placement="right">
    ...
    <li class="nav-item" title="<?php _e("Template")?>" aria-selected="false" data-toggle="" data-placement="right">
    ...
    <li class="nav-item" title="<?php _e("Export participants in a group")?>" aria-selected="false" data-toggle="" data-placement="right">
