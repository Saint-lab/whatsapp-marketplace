...
$query = $db->get( 'sp_market' );
$result = $query->result();
foreach( $result as $row ) 
{
    $route[$row->name] = 'market/index/'.$row->name;
    $route[$row->name.'/(:any)'] = 'market/index/'.$row->name;
}

$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;

$route['blog'] = THEME_FRONTEND.'/blog';
$route['blog/(:any)'] = THEME_FRONTEND.'/blog';
...
$route['handleStripePayment']['post'] = "market/handlePayment";
